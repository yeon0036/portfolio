    ...
    <div>
      ...
      <div className={styles.container}>
        ...
        <Image
          ...
          height={400}
        />
        <p className={styles.semiTitle}>메인 페이지 - 검색</p>
        <Image
          className={styles.overviewImg}
          src="/images/WHYNE/WHYNE1-1.png"
          alt="WHYNE main page - serch"
          width={600}
          height={400}
        />
        ...
        <Image
          ...
          height={400}
        />
        <p className={styles.semiTitle}>와인 상세 페이지 - 리뷰작성</p>
        <Image
          className={styles.overviewImg}
        ...
        <Image
          ...
          height={400}
        />
        <p className={styles.semiTitle}>마이페이지 - 프로필수정</p>
        <Image
          className={styles.overviewImg}
